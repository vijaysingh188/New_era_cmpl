# Generated by Django 2.2.12 on 2020-08-27 10:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('speciality1', models.CharField(max_length=150, null=True)),
                ('speciality2', models.CharField(max_length=150, null=True)),
                ('speciality3', models.CharField(max_length=150, null=True)),
                ('practicing_since', models.CharField(max_length=150, null=True)),
                ('reg_no_number', models.CharField(max_length=150, null=True)),
                ('reg_no_state', models.CharField(max_length=150, null=True)),
                ('reg_no_year', models.CharField(max_length=150, null=True)),
